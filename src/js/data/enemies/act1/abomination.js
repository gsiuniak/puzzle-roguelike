...
const abomination = {
  ...
  hp: 16, // floor-1-equivalent baseline (MapScene scales maxHp by depth); 2026-07-06: 25→16 (a MINION measured at 63-70% player win — band 85-95%; less HP = fewer bites for its Disease/attack ramp)
  maxHp: 16,
  attack: 2,
  armor: 0,
