...
const chokeweed = {
  ...
  hp: 20, // floor-1-equivalent baseline (MapScene scales maxHp by depth); 2026-07-06: 16→20 (measured 99-100% player win — band 85-95%; more HP = more turns for its Encroach ramp to matter)
  maxHp: 20,
  attack: 3, // 2026-07-06: 2→3 — measured 97-98% player win (band 85-95%); a higher ramp START makes Briarthorn bite sooner
  armor: 0,
