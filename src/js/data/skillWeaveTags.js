...
export const SKILL_WEAVE_TAGS = Object.freeze({
  ...
  intangible: { id: 'intangible', label: 'Intangible', category: TAG_CATEGORY.STATUS, rarity: TAG_RARITY.RARE, icon: null },
  berserk:    { id: 'berserk',    label: 'Berserk',    category: TAG_CATEGORY.STATUS, rarity: TAG_RARITY.RARE, icon: null },
