...
`ENEMY_HP_FLOOR_MULT` / `ENEMY_ATTACK_FLOOR_BONUS` live in the shared, dependency-free [`src/js/data/enemyScaling.js`](../../src/js/data/enemyScaling.js), imported by BOTH:
